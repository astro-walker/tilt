...
import (
	...
	client2 "github.com/astro-walker/tilt/internal/cli/client"
	...
	tiltfile2 "github.com/astro-walker/tilt/internal/controllers/core/tiltfile"
	...
	uiresource2 "github.com/astro-walker/tilt/internal/engine/uiresource"
	uisession2 "github.com/astro-walker/tilt/internal/engine/uisession"
...
func wireTiltfileResult(ctx context.Context, analytics2 *analytics.TiltAnalytics, subcommand model.TiltSubcommand) (cmdTiltfileResultDeps, error) {
	...
	plugin := k8scontext.NewPlugin(kubeContext, product)
