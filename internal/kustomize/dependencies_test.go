...
func TestRecursive(t *testing.T) {
	...
	// https://github.com/astro-walker/tilt/blob/15d0c94ccc08230d3a528b14cb0a3455b947d13c/vendor/sigs.k8s.io/kustomize/api/types/kustomization.go#L102
	kustomize := `bases:
- ./dev
resources:
- ./staging
...
// https://github.com/astro-walker/tilt/issues/4081
